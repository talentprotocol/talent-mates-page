...
import fs from "fs";
import { completeCreateTalentMateQuest } from "api-client";
...
const setMetaData = async (
  ...
  try {
    ...
    try {
      console.log("marking create talent mate quest as done");
      await completeCreateTalentMateQuest(userAddress);
    } catch (e) {
      console.log("error marking create talent mate quest as done", e);
    }
